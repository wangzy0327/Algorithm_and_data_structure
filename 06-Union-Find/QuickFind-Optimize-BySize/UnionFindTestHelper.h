...
#ifndef QUICKFIND_OPTIMIZE_BYSIZE_UNIONFINDTESTHELPER_H
#define QUICKFIND_OPTIMIZE_BYSIZE_UNIONFINDTESTHELPER_H
#include <iostream>
#include <ctime>
...
#endif //QUICKFIND_OPTIMIZE_BYSIZE_UNIONFINDTESTHELPER_H
